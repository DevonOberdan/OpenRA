		...
		public IEnumerable<TraitInfo> TraitsInConstructOrder()
		{
			...
			var more = unresolved.Where(u =>
				u.Dependencies.All(d =>
					...
					!unresolved.Any(u1 => AreResolvable(u1.Type, d))) &&
				u.OptionalDependencies.All(d =>
					!unresolved.Any(u1 => AreResolvable(u1.Type, d))));
...
#pragma warning restore CA1851
			...
			if (unresolved.Count != 0)
			{
				...
				var missing = unresolved.SelectMany(u => u.Dependencies.Where(d => !source.Any(s => AreResolvable(s.Type, d)))).Distinct();
